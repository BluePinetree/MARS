"""Command execution and result reading tools for LangGraph nodes."""
        ...
        return {
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "working_dir": {"type": "string", "description": "Absolute path to working directory"},
    ...
    def to_anthropic_schema(self) -> dict:
        return {
            ...
            "input_schema": {
                "type": "object",
                "properties": {
                    "result_path": {"type": "string", "description": "Absolute path to result JSON file"},
                },
