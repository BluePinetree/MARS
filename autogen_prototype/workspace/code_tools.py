"""Syntax check and import check tools for AutoGen agents."""
...
class SyntaxCheckTool:
    ...
    def as_autogen_callable(self, workspace_root: str):
        ...
        _syntax_check.__name__ = self.name
        _syntax_check.__doc__ = self.description
...
class ImportCheckTool:
    ...
    def as_autogen_callable(self, workspace_root: str):
        ...
        _import_check.__name__ = self.name
        _import_check.__doc__ = self.description
